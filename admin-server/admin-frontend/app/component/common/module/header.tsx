...
function ResponsiveAppBar() {
  ...
  <a href= {PG.HOME} className="flex items-center space-x-3 rtl:space-x-reverse">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    ...
    { linkButtonTitles.map((elem)=>(<li>
        <LinkButton key={elem.id} id={elem.id} title={elem.title} path={elem.path}/></li>
      ))}
