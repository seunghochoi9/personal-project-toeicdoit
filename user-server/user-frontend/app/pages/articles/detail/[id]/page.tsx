...
export default function ArticleDetailPage({ params }: any) {
  ...
  return (<>
    ...
    <span>writer</span><Typography textAlign="center" sx={{ fontSize: "1.5rem" }}>  {getArticle.writer}</Typography>
    <span>boardId</span><Typography textAlign="center" sx={{ fontSize: "1.5rem" }}>  {getArticle.boardId}</Typography>
