...
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (1, 'Clarinda', 'Boilermaker1!', 'dumy1@email.com', 'Chrissie', '230-644-4753', 'Professor', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (2, 'CulionIsland', 'Ironworker1!', 'dumy2@email.com',  'Fannie', '372-654-5644', 'Analog Circuit Design manager', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (3, 'HoumaHouma', 'Ironworker1!', 'dumy3@email.com', 'Zaria', '921-901-6334', 'Media Manager II', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (4, 'Recife', 'TileSetter1!', 'dumy4@email.com', 'Alisun', '868-948-4104', 'Budget/Accounting Analyst I', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (5, 'SegeSege', 'Plasterers1!', 'dumy5@email.com', 'Pennie', '940-551-8764', 'Financial Analyst', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (6, 'Nacala', 'Millwright1!', 'dumy6@email.com', 'Gertruda', '517-268-7651', 'VP Marketing', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (7, 'Tobermorey', 'SafetyOfficer1!', 'dumy7@email.com', 'Harli', '136-238-7702', 'VP Sales', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (8, 'MendeBrenoux', 'HVACHVAC1!', 'dumy8@email.com', 'Rosalia', '524-152-5660', 'Help Desk Technician', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (9, 'Bouarfa', 'Refridgeration1!', 'dumy9@email.com', 'Eugenie', '913-369-7000', 'Executive Secretary', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (10, 'Bucharest', 'SheetMetalWork1!', 'dumy10@email.com', 'Nina', '688-278-3563', 'Payment Adjustment Coordinator', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (11, 'KepiPapuaIsland', 'TileSetter1!', 'dumy11@email.com', 'Ashley', '595-588-1044', 'Geologist III', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (12, 'Cairo11', 'Waterproofer1!', 'dumy12@email.com', 'Antonia', '202-338-4567', 'Tax Accountant', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (13, 'Butare', 'Plasterers1!', 'dumy13@email.com', 'Martita', '978-322-8638', 'Engineer I', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (14, 'Buenaventura', 'Welder1!', 'dumy14@email.com', 'MinMinMin', '472-388-3046', 'Human Resources Assistant II', now(), now());
insert into users (id, username, password, address_id, name, phone, job , reg_date, mod_date) values (15, 'opera1', 'EquipmentOperator1!', 'dumy15@email.com', 'Antonie', '658-863-0908', 'Physical Therapy Assistant', now(), now());
